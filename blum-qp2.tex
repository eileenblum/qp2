...
(\ref{sgexar}), the superscript `n' represents the possible number of
...
before a +G vowel. An ASL\textsuperscript{g} grammar, however, does not
distinguish (\ref{sgexar}a) and (\ref{sgexar}b) from (\ref{sgexar}c).
