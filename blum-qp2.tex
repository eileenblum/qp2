...
Revisions (p. = page, l. = line): \newline p.4, l.124 fix spelling of
\enquote{analysis} \newline p.5, l.162 change \enquote{one element on a
feature} to \enquote{one element on each feature tier} \newline p.12,
l.360 reword second sentence to define locality \newline p.12, l.362 fix
spelling of \enquote{adjacent} \newline 
