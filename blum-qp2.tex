...
features, but no +G vowel. In the ARs below, the superscript `n'
represents the possible number of vocalic elements that can occur in a
given position with the same featural associations.
