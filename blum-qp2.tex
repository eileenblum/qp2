...
vowels, which are also all either +back or -back. A pound sign
...
(\ref{finnish.poytana}). While the Finnish pattern is captured by
(\ref{fsc.finnish}), the FSC does not need to refer to the morpheme
boundary because the same harmony pattern holds within roots as well as
between root and suffix morphemes.
