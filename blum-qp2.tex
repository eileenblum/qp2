...
*) with the logical notion of forbidding a substructure, like r\(_1\) in
(\ref{fsg}). A forbidden substructure grammar is thus the conjunction of
surface markedness constraints that rule out ill-formed substructures.
Jardine (2017) utilizes these FSCs over two-tiered ARs to describe major
tone patterns while excluding unattested ones. This qualifying paper
will utilize the same FSCs over multi-tiered ARs to describe major vowel
harmony patterns and to exclude an unattested one, sour grapes.
