...
\end{enumerate}
  ...
  Lastly for point #1, I changed the ungrammatical Finnish example (20b) in section 3.2 on page 15, line 430 so that it shows why disagreement across a transparent vowel is ungrammatical and I added a sentence stating as much on lines 443-446. I also added an explanation to the paragraph above the example\textemdash on lines 427-435\textemdash of how the Finnish FSCs both allow transparent vowels to occur anywhere in a word and enforce +back agreement across them by forbidding ARs with more than one back feature when the -back vowel is also either +low or +round.
