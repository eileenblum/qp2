...
The Finnish harmony generalization is that all the -neutral vowels in a root will share the same back feature with each other and -neutral suffix vowels will share the same back feature with the root-final -neutral vowel [@valimaablum1986; @ringenheinamaki1999]. For example, the words in (\ref{finnish_-neutral}) contain only -neutral vowels, which are also all either +back or -back. A pound sign represents a morpheme boundary.
...
\ex{\textipa{[p\o yt\ae-n\ae]} `table (essive)'}\label{finnish.poytana}
  ...
  {
(a) &          & |(a)| -back    &         &         &           &         &  & \\ 
    & |(b)| p  & |(c)| \o       & |(d)| y & |(e)| t & |(f)| \ae & |(t)| $\#$ & |(g)| n & |(r)| \ae \\
    &          & |(h)| -neutral &         &         &           &         &  &  \\          
(b) * &         & |[red](i)| \textbf{-back} &         &         &                         &               &         & |[red](j)| \textbf{+back} \\
      & |(k)| p & |(l)| \o                  & |(m)| y & |(n)| t & |[red](o)| \textbf{\ae} & |(u)| $\#$ & |(p)| n & |[red](s)| \textbf{\textipa{A}} \\
      &         & |[red](q)| \textbf{-neutral} &                &                         &               &         & \\
  };
