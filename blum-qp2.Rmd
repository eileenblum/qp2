...
\noindent In (\ref{nsg}a-c) nasality spreads from an [m] onto each segment to the right of it. In (\ref{nsg} d-f) an [s] is introduced, which prevents nasality from spreading at all. In (\ref{nsg}e-f) it becomes clear that [s] only blocks nasal spreading to its left, but does not affect the rightward spread of nasality from [m] to the right of [s].
